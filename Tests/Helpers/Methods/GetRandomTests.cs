...
namespace HaSe.Tests.Helpers.Methods {
    [TestClass] public class GetRandomTests : BaseTests {
        ...
        [TestMethod] public void ObjectTest() {
            var x = GetRandom.Object<StudentViewModel>();
            var y = GetRandom.Object<StudentViewModel>();
            var z = new StudentViewModel();
            Assert.IsInstanceOfType<StudentViewModel>(x);
            Assert.IsInstanceOfType<StudentViewModel>(y);
